...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnim() {
        ...
        val nameEdt = ObjectAnimator.ofFloat(binding.nameEditTextLayout, View.ALPHA, 1f).setDuration(500)
        ...
        AnimatorSet().apply {
            playSequentially(title, nameTv, nameEdt, emailTv, emailEdt, passwordTv, passwordEdt, signUpButton)
            startDelay = 500
        }.start()
    }
